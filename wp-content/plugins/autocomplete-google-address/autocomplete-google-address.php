...
function autocomplete_google_enqueue_scripts()
{
	...
	wp_enqueue_script('google-maps', 'https://maps.googleapis.com/maps/api/js?key=' . (!empty($google_api_key) ? $google_api_key : 'AIzaSyB16sGmIekuGIvYOfNoW9T44377IU2d2Es') . '&libraries=places&types=establishment&latlng=41.015137,28.979530&region=TR&language=tr', array('jquery-core', 'jquery', 'autocomplet-custom'), '1.0', true);
}
// Putting on wp head
