...
?>
	<table class="yaymail_builder_table_items_border yaymail_builder_table_tracking_item" cellspacing="0" cellpadding="6" border="1" style="width: 100% !important;<?php echo esc_attr( $borderColor ); ?>" width="100%">
		...
		<tbody style="border-width: 1px; border-style: solid; border-color: inherit;">
			<tr>
				<td class="td" scope="col" style="text-align: <?php echo esc_html( $text_align ); ?>; padding: 12px;<?php echo esc_attr( $fontFamily ); ?>"><?php echo esc_html( 'YayMail' ); ?></td>
				<td class="td" scope="col" style="text-align: <?php echo esc_html( $text_align ); ?>; padding: 12px;<?php echo esc_attr( $fontFamily ); ?>"><a href="#" ><?php echo esc_html( '111111' ); ?></a></td>
			</tr>
		</tbody>
	</table>
<br/>
