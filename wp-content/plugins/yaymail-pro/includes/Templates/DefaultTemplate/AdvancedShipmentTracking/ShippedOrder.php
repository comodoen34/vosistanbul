...
class ShippedOrder {
	...
	public static function getTemplates() {
		...
		*/
		$emailTitle          = __( 'Your Order is Shipped', 'woocommerce' );
		$emailtext           = esc_html__( 'Hi there. We thought you’d like to know that your recent order from ', 'woocommerce' ) . esc_html( do_shortcode( '[yaymail_site_name]' ) ) . esc_html__( ' has been shipped.', 'woocommerce' );
      ...
      ';
		if ( class_exists( 'WC_Advanced_Shipment_Tracking_Actions' ) || class_exists( 'AST_PRO_Install' ) ) {
			$elements .= '{
    ...
    },
    {
      ...
      "settingRow": {
		...
		$templates['customer_shipped_order']['elements'] = $elements;
		return $templates;
	}
}
