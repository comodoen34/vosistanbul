...
<div class="woocommerce-order">
	...
	?>
		...
		<?php else : ?>
			<h2 class="woocommerce-order-details__title" style="text-align: center; margin-bottom: 30px;">Teşekkür Ederiz!</h2>
			<p class="woocommerce-thankyou-order-received" style="text-align:center;">Siparişinizi özenle hazırlayıp teslim edeceğiz.<br />
				Siparişiniz hazırlanıp yola çıktığında ve teslim edildiğinde size tekrar bilgi vereceğiz.</p>
			<?php /*
	...
	<p class="woocommerce-thankyou-order-received" style="text-align:center; margin-top: 20px;">Tüm soru ve görüşleriniz için:</p>
	<p class="woocommerce-thankyou-order-received" style="text-align:center;">hello@vosistanbul.com <br />0216 999 37 97</p>
