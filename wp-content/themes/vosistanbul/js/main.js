  ...
  $(".mini-cart").hover(
    function () {
      if (
        ...
        $(this).children().hasClass("cart-dropdown")
      ) {
...
------------------------------*/
  ...
  $(".testimonial-active-landing").owlCarousel({
    nav: true,
    loop: true,
    navText: [
...
----------------------------------*/
  $("[data-countdown]:not(.pro-countdown1)").each(function () {
    ...
    $this.countdown(finalDate, function (event) {
      $this.html(
        event.strftime(
          '<div class="single-count"><span>%D</span>Gün</div><div class="single-count"><span>%H</span>Saat</div><div class="single-count"><span>%M</span>Dakika</div><div class="single-count"><span>%S</span>Saniye</div>'
        )
      );
    });
  });
...
----------------------------------*/
  $("[data-countdown].pro-countdown1").each(function () {
    ...
    $this.countdown(finalDate, function (event) {
      $this.html(
        event.strftime(
          '<div class="single-count-1"><span>%D</span>Gün</div><div class="single-count-1"><span>%H</span></div><div class="single-count-1"><span>%M</span></div><div class="single-count-1"><span>%S</span></div>'
        )
      );
    });
  });
