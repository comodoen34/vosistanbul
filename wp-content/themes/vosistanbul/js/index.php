...
<div class="feature-area mt-50">
  <div class="container">
    ...
    <div class="text-center mb-70">
      <button type="button" href="#" class="discoverButton text-center m-0 ms-auto mt-5" style="margin-right: auto !important; max-width: 300px;" data-toggle="modal" data-target="#myModal">Teslimat Bölgelerimiz</button>
    </div>
    <div class="row">
...
<div class="modal" tabindex="-1" id="#discover-modal">
